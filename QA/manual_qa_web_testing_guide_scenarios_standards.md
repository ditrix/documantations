...
Для Junior QA важно понимать:
- какие этапы существуют
- кто участвует на каждом этапе
- где и как подключается QA
...
**Что происходит:**
- формируется идея продукта
- собираются бизнес-требования
- описываются ожидания пользователя

**Участники:**
- Бизнес-аналитик (BA)
- Product Owner
- Stakeholders
- QA (на раннем этапе — опционально)

**Роль QA:**
- анализ требований на полноту и логичность
- выявление противоречий и рисков
...
- определяются технологии
- создаются технические решения
...
- уточнение сценариев
- smoke / sanity проверки (если применимо)
...
**Участники:**
- QA / QC / тестировщик
- Разработчики (исправление дефектов)
...
**Что происходит:**
- выкладка продукта
- проверка на production / staging
...
**Роль QA:**
- приёмка релиза
- финальная проверка (release testing)
